...
async function run() {
  try {
    ...
    // properties data post api create by Sojib [done]
    ...
    // properties data get api create by Sojib [done]
    ...
    //This API calls the rent request of an owner by konika [done]
    ...
    //this Api call the rentOutProperties  of an owner by konika [done]
    ...
    //this Api call the  SoldProperties of an owner by konika [done]
    ...
    // This Api Is for getting saved properties for individual users. By Email query [done]
    // app.get("/saved-properties", async (req, res) => {
    //   try {
    ...
    // blogs get api create & codded by sojib [done]
